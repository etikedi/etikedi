...
export const ProcessConfig = {
    AL_MODEL: Choice(['DecisionTreeClassifier', 'RandomForestClassifier', 'LogisticRegression', 'NaiveBayes', 'SVC', 'MLP']),
}
...
export const BattleConfig = {
    ...
    AL_MODEL: Choice(['DecisionTreeClassifier', 'RandomForestClassifier', 'LogisticRegression', 'MLP']),
