...
<h1>Upload</h1>
<input type="file" bind:this={data} style="display: none" multiple accept="application/json"
       on:input={() => initFiles(data)}>
<input type="file" bind:this={features} style="display: none" multiple accept="image/*"
...
<div bind:this={displayFiles}></div>
<button class="btn card" on:click={upload}>
    <span>Upload</span>
</button>