...
def import_dataset(dataset: Dataset, sample_class: Type[Sample], features: Union[Path, FileStorage], content: Union[Path, FileStorage], user: User = None, ensure_incomplete=True):
    if not user:
        try:
